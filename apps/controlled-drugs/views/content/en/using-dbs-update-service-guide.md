...
- their full name
- their date of birth
- explicit consent for the DFLU to access the service
- a DBS reference (the certificate number or application reference number)
- the date of issue or application date